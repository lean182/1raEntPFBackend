# PRE-ENTREGA 1 / PROYECTO FINAL BACKEND

## Introducción

Se desarrolló un servidor que contiene los endpoints y
servicios necesarios para gestionar los productos y
carritos de compras en un e-commerce.

Se adjuntan imagenes del manejo de productos y carritos.
...
<div align="center">
    <img src="./imgREADME/Productos/POST agregando el mismo producto a la lista de productos.png" alt="POST agregando el mismo producto a la lista de productoso" width="400" style="border: 2px solid #000; box-shadow: 3px 3px 5px #ccc;"/>
</div>
...
<div align="center">
    <img src="./imgREADME/Carritos/POST agregar un nuevo carrito.png" alt="POST agregar un nuevo carritoo" width="400" style="border: 2px solid #000; box-shadow: 3px 3px 5px #ccc;"/>
</div>
